...
try{
    $polaczenie = new mysqli($host,$db_user,$db_password,$db_name);
        if($polaczenie->connect_errno!=0){
            ...
            sprintf("SELECT tytul,autor,data_rez,data_zamow,data_zwrotu FROM wypozyczenie JOIN egzemplarz ON egzemplarz_id=id_egzemplaz JOIN ksiazka ON ksiazka_id=id_ksiazka WHERE czytelnik_id='%d' ORDER BY data_zamow DESC;",
