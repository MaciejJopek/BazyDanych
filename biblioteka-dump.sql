...
INSERT INTO `bibliotekarz` VALUES (1,'Filip','Bibliotekarz','login1','6d932c406fa15164ee48ff5a52f81dae'),(2,'Dorota','Karp','login2','ed71c5d55af657bc2413020e5580d4dd'),(3,'Henryk','Okon','login3','daa9bda719032ae88abadb9cda4aa846'),(4,'Ala','Book','login4','4bc0550cd0afc7bbe97be48a36303f6e'),(5,'Szymon','Krewetka','login5','464ded0c9aa3f20e0d5c6463e227f8a8');
...
CREATE TABLE `egzemplarz` (
  ...
  `status` enum('wypozyczone','nie wypozyczone') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `egzemplarz` VALUES (1,'Albatros',2010,5,'978-83-2440-387-5',200,'wypozyczone'),(2,'Prószyński i S-ka',2013,3,'978-83-653150-1-4',300,'wypozyczone'),(3,'Zysk i S-ka',2012,1,'978-83-7839-535-5',350,'wypozyczone'),(4,'Insignis',2015,2,'978-83-8031-450-4',150,'wypozyczone'),(5,'Świat Książki',2017,4,'978-83-66071-91-9',444,'wypozyczone');
...
INSERT INTO `ksiazka` VALUES (1,'J.R.R. Tolkien','Hobbit',2),(2,'Dmitry Glukhovsky','Metro 2033',2),(3,'Stephen King','Joyland',4),(4,'Paula Hawkins','Dziewczyna z pociagu',1),(5,'Nicholas Sparks','Pamietnik',3);
...
-- Dump completed on 2020-05-14 12:53:48
